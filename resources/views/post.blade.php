...
@section('content')
        ...
        <div class="flex justify-between gap-5">
            <div class=" w-4/6">
                <div class="flex justify-start">
                    <p class=" text-4xl uppercase font-bold text-[#3E6E8B]">UPACARA HARLAH PANCASILA 2023 ITPROVSU</p>
                </div>
                ...
                <div class="">
                    <div class=" gap-10 mt-10">
                        <img src="tes.jpg" class=" w-[50rem]   border border-black/10" alt="">
                        <div class=" grid justify-stretch mt-10">

                            <p class=" capitalize  font-semibold break-words text-black/70">Medan (01/06),
    ...
    <div class="w-full mt-20 px-28">
        ...
        <div class="w-1/2 mt-10">
            ...
            <div class="">
                <input type="text" class=" h-80 mt-10 w-full placeholder:text-center" placeholder="Masukkan Komen Anda">
            </div>
            <div class="w-full">
