...
@section('content')
    ...
    <section class="bg-white dark:bg-gray-900 mt-5 ">
        <div class="max-w-2xl  py-10 mx-auto lg:py-16">
            <h2 class="mb-4 text-3xl  font-bold text-gray-900 dark:text-white text-center">Edit Agenda</h2>
            <form action="/admin/agenda/{{$berita->id}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
