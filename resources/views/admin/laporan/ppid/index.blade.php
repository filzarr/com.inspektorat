            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <div class="w-full md:w-1/2">
                        <p class="text-2xl font-semibold text-[#063A69]">Laporan PPID Inspektorat</p>
                    </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Jenis Laporan</th>
                        ...
                        <tbody>
                            @foreach ($data as $data)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    @else
                                        ...
                                        <td class="px-4 py-3"><button class="px-2 py-2 text-gray-200 rounded-lg bg-green-600">Sudah Dibalas</button></td>
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            <button id="{{$data->id}}-dropdown-button"
                                                data-dropdown-toggle="{{$data->id}}-dropdown"
                                                class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                            ...
                            @foreach ($item as $data)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">Laporan Keberatan</td>
                                    <td class="px-4 py-3">{!! $data->deskripsi !!}</td>
                                    @if (is_null($data->balasan))
                                        <td class="px-4 py-3">-</td>
                                        <td class="px-4 py-3"><button
                                        ...
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            ...
                                            <div id="{{$data->id}}-dropdown"
                                                ...
                                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                    aria-labelledby="{{$data->id}}-dropdown-button">
                                                    <li>
                                                        <a href="ppid/pelaporan-informasi/{{$data->id}}"
                                                            class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Tampil</a>
                                                    </li>
                                                    <li>
                                                        <a href="ppid/{{$data->id}}/balasan"
                            ...
                            {{-- <tr class="border-b dark:border-gray-700">
                                <th scope="row"
                                    class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">Filza Rizki Ramadhan</th>
                                <td class="px-4 py-3">10 November 2003</td>
                                <td class="px-4 py-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste vero, veniam quibusdam provident quas aut earum illo aliquam accusamus nostrum asperiores adipisci necessitatibus maiores animi quasi possimus architecto eaque ut.</td>
                                <td class="px-4 py-3"><button class="px-2 py-2 text-gray-200 rounded-lg bg-green-600">Sudah Dibalas</button></td>
                                <td class="px-4 py-3 flex items-center justify-end">
