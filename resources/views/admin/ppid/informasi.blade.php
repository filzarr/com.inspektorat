            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div
                        ...
                        <a href="/admin/ppid/kelolainformasi/create">
                            <button type="button"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                <td class="px-4 py-3">Laporan Harta Kekayaan Penyelenggara Negara (LHKPN) Pimpinan</td>
                                <td class="px-4 py-3">Informasi Profil Inspektorat</td>
                                <td class="px-4 py-3">20 November 2023</td>
                                <td class="px-4 py-3">Informasi Publik</td>
                                <td class="px-4 py-3">https://covid19.sumutprov.go.id/</td>
