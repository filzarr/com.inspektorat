            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <div class="w-full md:w-1/2">
                        <p class="text-2xl font-semibold text-[#063A69]">Galeri Video Inspektorat</p>
                    </div>
                    <div
                        class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        <a href="/admin/galerivideo/create">
                            <button type="button"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        @foreach($video as $a)
                            <tr class="border-b dark:border-gray-700">
                                <td class="px-4 py-3">   <img src="https://drive.google.com/thumbnail?id={{ $a->links }}" class=" w-32"
                        alt=""></td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="apple-imac-27-dropdown-button" data-dropdown-toggle="{{$a->id}}"
                                    ...
                                    <div id="{{$a->id}}"
                                        ...
                                        <div class="py-1">
                                            <a href="{{ route('galerivideo.destroy', $a->id) }}"
