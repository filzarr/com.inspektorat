...
@section('content')
    ...
    <section class="bg-white dark:bg-gray-900 mt-5 ">
        <div class="max-w-2xl  py-10 mx-auto lg:py-16">
            <h2 class="mb-4 text-3xl  font-bold text-gray-900 dark:text-white text-center">Edit Galeri Foto</h2>
            <form action="/admin/galerifoto/{{$data->id}}" method="post" enctype="multipart/form-data">
            @csrf
                @method('PATCH')
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    <div class="sm:col-span-2">
                        <label for="name" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Keterangan
                            Gambar</label>
                        <input type="text" name="deskripsi" id="name" value="{{$data->deskripsi}}"
