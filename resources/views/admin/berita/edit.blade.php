...
@section('content')
    ...
    <section class="bg-white dark:bg-gray-900 mt-5 ">
        <div class="max-w-2xl  py-10 mx-auto lg:py-16">
            <h2 class="mb-4 text-3xl  font-bold text-gray-900 dark:text-white text-center">Edit Berita</h2>
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    <div class="sm:col-span-2">
                        <label for="name" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Judul
                            Berita</label>
                        <input type="text" name="judul" id="name" value="{{$berita->judul}}"
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker datepicker-autohide type="text" name="created_at"
                            ...
                            placeholder="Pilih Tanggal" value="{{ \Carbon\Carbon::parse($berita->created_at)->format('M/d/Y') }}" >
                    </div>
                    <div class="sm:col-span-2">
                    ...
                    <div class="">
                        ...
                        <input
                            ...
                            aria-describedby="file_input_help" id="file_input" type="file" name="image" value="{{$berita->gambar}}" >
