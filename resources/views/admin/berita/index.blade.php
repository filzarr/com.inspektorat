            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <div class="w-full md:w-1/2">
                        <p class="text-2xl font-semibold text-[#063A69]">Berita Inspektorat</p>
                    </div>
                    <div
                ...
                <div class="overflow-x-auto mt-3">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-4 py-3" width="50%">Judul</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <td scope="row" width="10%"
                                    class="px-4 py-3 font-medium text-gray-900  dark:text-white">{{$item->judul}}</td>
                                <td class="px-4 py-3"><img src="/images/{{$item->image}}" class="w-10 h-10" alt=""></td>
                                <td class="px-4 py-3">{{$item->views}}</td>
                                <td class="px-4 py-3">4</td>
                                <td class="px-4 py-3">{{ \Carbon\Carbon::parse($item->created_at)->format('d M Y') }}</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="apple-imac-27-dropdown-button" data-dropdown-toggle="{{$item->id}}"
