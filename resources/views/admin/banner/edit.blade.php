...
@section('content')
    ...
    <section class="bg-white dark:bg-gray-900 mt-5 ">
        <div class="max-w-2xl  py-10 mx-auto lg:py-16">
            <h2 class="mb-4 text-3xl  font-bold text-gray-900 dark:text-white text-center">Edit Banner</h2>
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    <div class="sm:col-span-2">
                        <label for="name" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Judul
                            Banner</label>
                        <input type="text" name="judul" id="name" value="{{$banner->judul}}"
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker datepicker-autohide type="text" name="created_at"
                            ...
                            placeholder="Pilih Tanggal" value="{{ \Carbon\Carbon::parse($banner->created_at)->format('M/d/Y') }}" >
                    </div>
                    <div class="sm:col-span-2">
                        <label for="description"
                            ...
                            <trix-editor input="description" >{!!$banner->deskripsi!!}</trix-editor>
                    </div>
                    <div class="">
                        <img src="/images/{{$banner->image}}" class="w-20 h-20" alt="">
                        <label class="block mb-2 text-lg font-medium text-gray-900 dark:text-white" for="file_input">Ganti Foto</label>
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            aria-describedby="file_input_help" id="file_input" type="file" name="image" value="{{$banner->gambar}}" >
