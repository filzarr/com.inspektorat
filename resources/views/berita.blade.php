    ...
    <div class="w-full mt-20 px-28 mb-2 0">
        ...
        <div class="flex justify-between gap-10">
            <div class=" w-3/6">
                ...
                <div class="grid auto-rows-auto  gap-10">
                    ...
                    @if (Route::is('bert'))
                        <div class="flex gap-10">
                            ...
                            <div class=" grid justify-stretch">
                                <a href="/berita/{{ $item->slug }}">
                                <p class="text-[#3E6E8B] text-lg font-bold">{{ $item->judul }}</p></a>
                                ...
                                <div class=" capitalize text-xs font-semibold break-words text-black/70">
                                    {!! Illuminate\Support\Str::limit(strip_tags($item->deskripsi), $limit = 100, $end = '...') !!}
                                </div>
                            </div>
                        </div>
                        @else
